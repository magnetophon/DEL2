                ...
                VStack::new(cx, |cx| {
                    ...
                    HStack::new(cx, |cx| {
                        ...
                        HStack::new(cx, |cx| {
                            Label::new(cx, "mode").class("slider-label");
                            ParamSlider::new(cx, Data::params, |params| {
                                &params.taps.velocity_high.mode
                            })
                            .class("widget");
                        })
                        .class("row");
...
impl DelayGraph {
    ...
    fn draw_time_line(
        ...
        let z_plane = vg::Point3::new(0.0, 0.0, 21.0); // Raised z-plane
    ...
    fn draw_in_out_meters(
        ...
        let mut path = vg::Path::new();
        let x_val = line_width.mul_add(0.5, bounds.x);
    ...
    fn draw_tap_velocities_and_meters(
        ...
        let ambient_color = Color::rgba(r, g, b, 155);
